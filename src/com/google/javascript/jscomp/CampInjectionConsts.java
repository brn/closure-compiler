...
public class CampInjectionConsts {
  ...
  static final String JOIN_POINT = "camp.injections.JoinPoint";
  static final String JOIN_POINT_GET_CLASS_NAME = "getClassName";
  static final String JOIN_POINT_GET_METHOD_NAME = "getMethodName";
  static final String JOIN_POINT_GET_QUALIFIED_NAME = "getQualifiedName";
  static final String JOIN_POINT_GET_ARGUMENTS = "getArguments";
  static final String JOIN_POINT_GET_RESULT = "getResult";
  static final String JOIN_POINT_GET_THIS = "getThis";
